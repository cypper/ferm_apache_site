<?php
/* Smarty version 3.1.30, created on 2018-02-25 23:22:12
  from "/home/cypper/Documents/localhost/modules/transactions/assets/edit_transaction.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a932904270d52_58234570',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a2c436b60398fd5f2e6e166a38ba6c9f766ad668' => 
    array (
      0 => '/home/cypper/Documents/localhost/modules/transactions/assets/edit_transaction.tpl',
      1 => 1519593730,
      2 => 'file',
    ),
  ),
...
function content_5a932904270d52_58234570 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
?>
    ...
    edit_delete.addEventListener("click", function() {
      var jqxhr = $.ajax( "/module/transactions/api?tns_api&tn_delete&id="+tn.id )
        .done(function(msg) {
          if (msg) {
            console.log(msg);
    ...
    edit_save.addEventListener("click", function() {
      ...
      $.ajax({
        ...
        url: "/module/transactions/api",
        data: serialize({ tn_edit:null, tns_api:null, id: tn.id, tn: new_tn }),
        processData: false,
      })
        .done(function(msg) {
          if (msg) {
    ...
    edit_check.addEventListener("click", function() {
      ...
      var jqxhr = $.ajax( "/module/transactions/api?tns_api&tn_get&id="+id )
        .done(function(msg) {
          console.log(msg);
          tn = msg;
          if (tn == null) {
