...
<form class="form-horizontal form-label-left" method="POST" action="/module/transactions/api">
  ...
  <div class="form-group">
    ...
    <div class="col-md-9 col-sm-9 col-xs-12">
      <textarea class="form-control" rows="3" placeholder='message {$vars.id}' name="message"></textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-9 col-sm-9 col-xs-12">
      <input type="text" name="date" id="autocomplete-custom-append" class="form-control col-md-10" required value="{$vars.date}" />
    </div>
  </div>
  <div class="form-group">
